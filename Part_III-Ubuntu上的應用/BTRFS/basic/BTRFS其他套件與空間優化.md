...
# 去除重複工具：Duperemove
去重也是BTRFS節省空間的方式之一，原理是BTRFS底層有一個`ioctl`，可以讓去重工具基於這個函式去實現對檔案的掃描和比對，有機會我在展開詳細的原理。
...
```
恩...去重後評估是少800多MB，實際上直接少8G (WTF)，如果算是zstd的壓縮我在Steam遊戲庫上面合計省了31G，以515GB邏輯大小來說大約6%，看起來杯水車薪，但打視角拉回2020年遊戲大小膨脹前的時代，我可以多裝一個2020年前的3A，或者安裝約30款Galgame，甚至安裝一大堆DLSite下載的同人遊戲(大小普遍都在1G左右，少數大於1.5G，多數小於1G)，挺不錯的。
